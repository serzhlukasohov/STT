(function () {
  ...
  window.getMaxUploadBytes = getMaxUploadBytes;
  window.getHostConfig = getHostConfig;
  window.buildClientUsageEstimate = buildClientUsageEstimate;
  window.getAudioDurationFromFile = getAudioDurationFromFile;
